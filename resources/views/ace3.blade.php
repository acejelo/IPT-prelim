...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div  class="d-flex aligns-items-center justify-content-center mt-5" role="alert">
        ...
        <div>
            <nav  class="d-flex aligns-items-center justify-content-center" style="height:200px">
                <ul class="d-flex list-unstyled m-5">
                    <li><a class="nav-link mt-5 text-secondary" href="{{url('/ace2')}}">Page 2</a></li>
                    <li><a class="nav-link mt-5 h5 success" href="{{url('/ace3')}}">Page 3</a></li>
